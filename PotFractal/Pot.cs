    ...
    class Pot
    {
        ...
        private void DrawPot() 
        {
            ...
            else
            {
                ...
                //code to reduce the value of the variable diameter by 2/3
                diameter = diameter - 6;
                //increment value of the variable step
                step++;
                //a recursive function/method call to invoke this method again
                DrawPot();
            }
        }
